...
class Account(Address):
    def __init__(self, address, normal_transactions: [NormalTransaction] = None, internal_transactions: [InternalTransaction] = None):
...
class ERC20(Contract):
    def __init__(self, address, name, symbol, supply, decimals, transfers):
...
class Pool(ERC20):
    def __init__(self, address, token0: ERC20 = None, token1: ERC20 = None, scammers=None, syncs=None, burns=None, swaps=None, transfers=None):
        super().__init__(address, transfers)
        self.token0 = token0
        self.token1 = token1
