...
def extract_completed_networks(in_path, out_path, network_list):
    for id in tqdm(network_list):
        file = os.path.join(in_path, f"cluster_{id}.csv")
        new_file = os.path.join(out_path, f"network_{id}.csv")
...
if __name__ == '__main__':
    ...
    extract_completed_networks(path.panv2_cluster_path, path.panv2_network_path , pan_accepted_cluster)