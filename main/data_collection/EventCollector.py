...
if __name__ == '__main__':
    collector = PoolEventCollector()
    # collector.download_pool_events("Burn", "univ2", EtherscanAPI, setting.ETHERSCAN_API_KEYS[1])
    # collector.download_pool_events("Mint", "univ2", EtherscanAPI, setting.ETHERSCAN_API_KEYS[2])
    collector.download_pool_events("Swap", "univ2", EtherscanAPI, setting.ETHERSCAN_API_KEYS[3])
    # collector.download_pool_events("Transfer", "univ2", EtherscanAPI, setting.ETHERSCAN_API_KEYS[4])
    # collector.download_pool_events("Sync", "univ2", EtherscanAPI, setting.ETHERSCAN_API_KEYS[5])
